...
import com.giantlink.glintranet.SpringApplicationContext;
import com.giantlink.glintranet.requests.UserLoginRequest;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest req,
        ...
        EmployeeService userService = (EmployeeService)SpringApplicationContext.getBean("employeeServiceImpl");
        
        EmployeeResponse employeeResponse = userService.get(userName);
